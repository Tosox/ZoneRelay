...
import de.tosox.zonerelay.gui.components.JImagePanel;
import de.tosox.zonerelay.gui.controllers.MainFrameController;
...
import de.tosox.zonerelay.utils.ImageUtils;
...
public class MainFrame extends JFrame {
    private static final BufferedImage ICON = ImageUtils.getFromPath(MainFrame.class.getResource("icon.png"));
